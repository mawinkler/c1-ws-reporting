...
def deep_security_usage_query(client, dsm_url, dsm_user, dsm_password, dsm_tenant, dsm_tenant_id, timespan_from, timespan_to):
...
def main():
    ...
    deep_security_usage_query(client, host, dsm_user, dsm_password, 0, dsm_tenant, timespan_from, timespan_to)
